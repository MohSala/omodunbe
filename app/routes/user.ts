...
userRouter.post("/registerTask", (req, res) => {
  return userController.registerTask(req, res);
});

userRouter.post("/createStaff", (req, res) => {
  return userController.createStaff(req, res);
});
...
userRouter.get("/latestActivity", (req, res) => {
  return userController.getLatestActivity(req, res);
});
